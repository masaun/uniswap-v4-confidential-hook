...
uint256 constant VK_HASH = 0x0635aad048b0fd90e6fa7faad12a4ff32cf77fb6d0476ae48f09414ca95bc01d;
library HonkVerificationKey {
    function loadVerificationKey() internal pure returns (Honk.VerificationKey memory) {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            ql: Honk.G1Point({ 
               x: uint256(0x29dc5b366f48cbc32f70767d2ddc2eabe15707a32c3b209798dad76ddb27ece3),
               y: uint256(0x262c7fc869cf4ce1e569523be6236fc32c9a1d9819cd8d611df98a9cc8987508)
            }),
            qr: Honk.G1Point({ 
               x: uint256(0x1b7ff3ff5099e0008389308c98e204dc25510d0762095e16798beec0b83ebbab),
               y: uint256(0x230d6068b7ef504728b14939bfe70ac2854dd4808c255322f4936ddf316d4601)
            }),
            qo: Honk.G1Point({ 
               x: uint256(0x02b3fb9de5c876d1139f29c339f975808fd09a0fad7fa4dfacc3a1416f7176c0),
               y: uint256(0x29bd8d7587a0f37e8dfe55f49c93048ba6b84d6f4580396e060885bc53db3394)
            }),
            q4: Honk.G1Point({ 
               x: uint256(0x1ea50bc4f64fc230179021f82958cf5a7bbf2ec333494a75fce08f230c2fbe7c),
               y: uint256(0x15aace38f3ee2302bf325e1feef47c1e75c4c15445532d52d72e429b5f7dfaf5)
            }),
            qm: Honk.G1Point({ 
               x: uint256(0x27990669e02db5a3e8425213e02ff0983c3766c589b8acae2f5af7c9d68cccaa),
               y: uint256(0x1f9b8c0aab520ec9707f3ef7da612186a87e4680b7fe7b679508bdeaa4207a91)
            }),
            qc: Honk.G1Point({ 
               x: uint256(0x12ed86effc1783cc76832809e306da5eabc1b0437fbef708251a3266b2298fa9),
               y: uint256(0x2c9b644013f3022654184eac19de4a1e142f0f2c0f00e1723e3b95a1a889c9e5)
            }),
            ...
            qArith: Honk.G1Point({ 
               x: uint256(0x069c7143744b0de828838d5275e9a1abf1fdfccc4113fce9e9f8c59add344e52),
               y: uint256(0x131dbd2b1d7957ea5fdc54e9ebeeec5e72f38bb2d684a1935a2ec5ad91b2eab3)
            }),
            qDeltaRange: Honk.G1Point({ 
               x: uint256(0x22090fdaf0a094e7f4a03ac7b36bcaf4ae0e47bf1cc12c89115e280247760430),
               y: uint256(0x2fad6fcd3494d31d8ceb394da53f8ccb1bfd8cfc43ce0936ba137597111cfc4c)
            }),
            qElliptic: Honk.G1Point({ 
               x: uint256(0x0f4a418ed153ec585f528dba761bcf7405a3b071ef4cefdfbaa50c283872ea60),
               y: uint256(0x2eb79ad828db155c349dc77b33ed3d1d48cbf1f4cf8f19bebc1c23f55af42f29)
            }),
            qMemory: Honk.G1Point({ 
               x: uint256(0x1fa4a779dcce9e8e29d6da38484c20aef53511d403e1a3a897053e856eac8742),
               y: uint256(0x0923c2f7103494ee37232ef1aa1ad513e0eaa72e59bda64f621661f2aa15bf6c)
            }),
            qNnf: Honk.G1Point({ 
               x: uint256(0x262a983d453120e19656c679236e7f4dc4854c431b30841c3e1d6d06e7ac07c0),
               y: uint256(0x1e3eacb1df175fdf5b31d0c9bf740f03ed7b0f5e29e5a4d6ad2a76084cc75b36)
            }),
            qPoseidon2External: Honk.G1Point({ 
               x: uint256(0x1ec5a4d9ceefc6c8c74335c8a31030534d41cb50a81bf72632968084c1f86365),
               y: uint256(0x103c093cfea90b0e6764ceeea62e20f041958e593799938f192bab1244913a12)
            }),
            qPoseidon2Internal: Honk.G1Point({ 
               x: uint256(0x04ca14beec35cf79dfbca4b3068c1da3c6fe4f2832e87c9b6a2af5d816ae3acb),
               y: uint256(0x1f6f82f79d5ae84b6500119fd7219f321b5eea85e4f2e06af487d5b627c84775)
            }),
            s1: Honk.G1Point({ 
               x: uint256(0x2585052979b91741f6bbb2a367629f0c337cb98d18722ab3aaf139a2ffa0fb74),
               y: uint256(0x2ed3f16d27fa01ab0f915480eaa47c84d1b59ca7edfa98310c7cedadf34c2a03)
            }),
            s2: Honk.G1Point({ 
               x: uint256(0x1c465aa3f2cd9507634d0ee3faadff9cebc58585db9e3990d2b8f6a27337f2bb),
               y: uint256(0x10a5533dc03270fb6bbc35ab77279d613b9da5fc73a56cd505313816727696bb)
            }),
            s3: Honk.G1Point({ 
               x: uint256(0x11db2c5b2ca9840729bcfe6a26a683da482351e6240f4440108706c5133a5ba3),
               y: uint256(0x01df9395659a9ca447c86ba67d9a1cc81610ec657ce69c98745252f9a85fd803)
            }),
            s4: Honk.G1Point({ 
               x: uint256(0x1ecfdc6ac2a1bcd59b99df34c41110f12eabc76bda211c85e2969ef196e93a61),
               y: uint256(0x143cab8c201e8bbb3711d43ea5efd3e0422e2a398fb83ab2ef9350ec4199c9bd)
            }),
            t1: Honk.G1Point({ 
            ...
            id1: Honk.G1Point({ 
               x: uint256(0x159ec58aa96add02a21cfc53b617f90e6b07b208c8dedf210c29f84e19f0fc05),
               y: uint256(0x2b1e5b9fb91e1a23c7c017f68c1d1e0a59bc81eaf834c4fd4351c6019a3fa6aa)
            }),
            id2: Honk.G1Point({ 
               x: uint256(0x28d8001921e3da0cc8392bba45a1f29da8951a2787de88e95cd9d8b6837b2cf2),
               y: uint256(0x08fd596257da08085058d263bc712cb28331cd1662d34111702fefb58a7f4a60)
            }),
            id3: Honk.G1Point({ 
               x: uint256(0x29d395a0ea5479d6ee0ca77694afbc244b85951fe8eccaf3c469e96dc7ff1bcf),
               y: uint256(0x12862d21241ba4304e04755833807a780d3b1f88b58333fda0a4281348cc35fd)
            }),
            id4: Honk.G1Point({ 
               x: uint256(0x111d9293d8713b904a2791964c795e2ef6f72d698089f3780dcecfae9c8e0bd8),
               y: uint256(0x1268e98c7e82573e1a6e9d0cfbd77e74c12b1302c1d0db7b401f2c107c7a3afe)
            }),
            ...
            lagrangeLast: Honk.G1Point({ 
               x: uint256(0x1afa124141808f8b53c9d12be699c713a484ffc9791d4472c1b172482e95f539),
               y: uint256(0x068b4a0f0490ae31b19c55131521a6e766f2ddf3e241838d74b7157c5ca284f5)
            })
        });
        return vk;
    }
