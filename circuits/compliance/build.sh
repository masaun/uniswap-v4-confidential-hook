...
bb write_vk -b ./target/compliance.json -o ./target/vk --oracle_hash keccak   # bb.js v3.0.0-devnet.6-patch.1
#bb write_vk -b ./target/compliance.json -o ./target/vk --oracle_hash keccak  # bb.js v0.87.0 (Same with v3.0.0-devnet.6-patch.1)
